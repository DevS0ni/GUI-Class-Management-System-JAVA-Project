...
"Physics Marks:" + " " + studentDetails.physicsMarks + "<BR>" +
"Biology Marks:" + " " + studentDetails.biologyMarks + "<BR>" +
"Maths Marks:" + " " + studentDetails.mathsMarks + "<BR>" +
line );
else
...
else if(avgMarks >= secondClass && avgMarks < firstClass) grade ="<BR>Second Class";
...
return(line + "Number of Student Passed: " + numberPassed + "<BR>" +
line);
}
...
buffer.append(line + "Student Having Top Marks: <BR>");
for(int id = 1; id <= lastID; id++)
{
studentDetails.getStudentDetails(id);
int studentMarks = studentDetails.physicsMarks +
